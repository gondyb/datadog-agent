...
// CollectorInterface is an interface for the MapOverRunningChecks method of the collector
type CollectorInterface interface {
	MapOverRunningChecks(func([]check.Info))
}
...
func createPayload(ctx context.Context, hostname string, coll CollectorInterface) *Payload {
	...
	if coll != nil {
		coll.MapOverRunningChecks(func(checks []check.Info) {
